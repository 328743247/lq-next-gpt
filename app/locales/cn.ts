...
const cn = {
    ...
    Error: {
        Unauthorized:
            ...
            "密码获取方式，关注公众号，回复\"密码\"。![公众号二维码](https://www.aiasker.online/gongzhonghao.png)",
    },
    ChatItem: {
    ...
    Settings: {
        ...
        AccessCode: {
            Title: "访问密码",
            SubTitle: "管理员已开启加密访问，关注微信公众号\"AI知识库\"获取密码",
            Placeholder: "请输入访问密码",
        },
        Model: "模型 (model)",
        Temperature: {
    ...
    Store: {
        ...
        BotHello:
            ...
            "2. 关注公众号不走丢，微信搜索“AI知识库”，或扫码关注。![公众号二维码](https://www.aiasker.online/gongzhonghao.png)",
        Error: "出错了，稍后重试吧",
        Prompt: {
